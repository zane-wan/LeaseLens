...
- `project-docs/developer-guide.md`: Synced this section with the latest main-branch comparison, cleanup pass, and current merge guidance for T1b/T6 dependents.
