      ...
      <div className="flex flex-col justify-between bg-muted p-6 md:p-10 lg:p-12">
        <div className="space-y-6">
          <blockquote className="space-y-2 border-l-4 border-primary pl-6 text-lg italic text-muted-foreground md:text-xl">
            <p>
              &ldquo;Getting started with LeaseLens was incredibly easy. Within
              minutes, I had professional analysis of my rental agreement and
              complete peace of mind about my exact tenant rights.&rdquo;
            </p>
      ...
      <div className="flex flex-col items-center justify-center p-6 md:p-10">
        <div className="w-full max-w-sm space-y-6">
          <div className="space-y-2 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Start analyzing your agreements today
            </p>
          </div>
          <SignupForm />
        </div>
